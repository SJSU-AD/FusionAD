...
PI = 3.14159
WHEEL_RADIUS = 0.7112
PULSES_PER_ROTATION = 2400
DT = 0.02

# initialize the publisher
velocity_estimate_publisher = rospy.Publisher('/localization/velocity', Float32, queue_size = 10)

def right_encoder_callback(right_encoder_msg):
    '''callback function for the right encoder
    '''
    global right_encoder_count
    right_encoder_count = right_encoder_msg.data
