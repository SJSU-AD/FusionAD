...
class PathInterpolatorUTM(GeodesyConverterUTM):
    ...
    def interpolation_publish_UTM(self):
        ...
        # print("\neastings =", eastings, "\nnorthings =", northings)
        relativeEasting, relativeNorthing = super(PathInterpolatorUTM, self).global_to_relative_UTM(eastings, northings)
        ...
        for i in range(numberOfCoarsePoints):
            finePointsEasting, finePointsNorthing = self.interpolate_UTM(i, relativeEasting, relativeNorthing, numberOfCoarsePoints)
