...
Convenience degrees-minute-second to decimal converter can be found here: https://repl.it/@DRmoto/DMStoDeg 
"""
...
heightsCN2002SF  = [63.685, 64.218, 63.774, 64.308]
...
def main():
    ...
    for i in range(min(len(latitudesCN2002), len(longitudesCN2002), len(heightsCN2002SF))):
        x, y, z = geodetic_to_ECEF_coordinates(latitudesCN2002[i], longitudesCN2002[i], heightsCN2002SF[i])
        X_Position.append(x)
        Y_Position.append(y)
        Z_Position.append(z)
