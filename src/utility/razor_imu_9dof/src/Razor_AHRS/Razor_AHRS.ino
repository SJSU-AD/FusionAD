...
//Uncommented 14004 for the Razor 9 Dof IMU from Sparkfun
...
float ACCEL_X_MIN = -262.82;
float ACCEL_X_MAX = 254.88;
float ACCEL_Y_MIN = -255.74;
float ACCEL_Y_MAX = 271.61;
float ACCEL_Z_MIN = -253.78;
float ACCEL_Z_MAX = 276.37;
...
float GYRO_AVERAGE_OFFSET_X = 0.04;
float GYRO_AVERAGE_OFFSET_Y = 0.02;
float GYRO_AVERAGE_OFFSET_Z = 0.03;
