#ifndef _ROS_piksi_rtk_msgs_TrackingState_V2_3_15_h
#define _ROS_piksi_rtk_msgs_TrackingState_V2_3_15_h
...
namespace piksi_rtk_msgs
{
  ...
  class TrackingState_V2_3_15 : public ros::Msg
  {
    public:
      ...
      enum { CODE_GPS_L2CM =  1 };
      enum { CODE_SBAS_L1CA =  2 };
      enum { CODE_GLO_L1CA =  3 };
      enum { CODE_GLO_L2CA =  4 };
      enum { CODE_GPS_L1P =  5 };
      enum { CODE_GPS_L2P =  6 };
    ...
    const char * getType(){ return "piksi_rtk_msgs/TrackingState_V2_3_15"; };
    const char * getMD5(){ return "0a051c9934e022ee2abf2e31fc142ed2"; };
