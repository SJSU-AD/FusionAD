#ifndef _ROS_piksi_rtk_msgs_Dops_h
#define _ROS_piksi_rtk_msgs_Dops_h
...
namespace piksi_rtk_msgs
{
  ...
  class Dops : public ros::Msg
  {
    ...
    const char * getType(){ return "piksi_rtk_msgs/Dops"; };
    const char * getMD5(){ return "5abef1c1cdd65cbee762c17ce2b5bdcb"; };
