#ifndef _ROS_piksi_rtk_msgs_GpsTime_h
#define _ROS_piksi_rtk_msgs_GpsTime_h
  ...
  class GpsTime : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 3) = (this->tow >> (8 * 3)) & 0xFF;
      ...
      u_ns.real = this->ns;
      *(outbuffer + offset + 0) = (u_ns.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_ns.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_ns.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_ns.base >> (8 * 3)) & 0xFF;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_ns.base = 0;
      u_ns.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_ns.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_ns.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_ns.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      this->ns = u_ns.real;
      offset += sizeof(this->ns);
    ...
    const char * getType(){ return "piksi_rtk_msgs/GpsTime"; };
    const char * getMD5(){ return "d960bffb66122e272126ef7f2b6ef072"; };
