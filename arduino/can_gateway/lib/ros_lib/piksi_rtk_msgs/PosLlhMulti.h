#ifndef _ROS_piksi_rtk_msgs_PosLlhMulti_h
#define _ROS_piksi_rtk_msgs_PosLlhMulti_h
...
namespace piksi_rtk_msgs
{
  ...
  class PosLlhMulti : public ros::Msg
  {
    public:
      ...
      _flags_type flags;
      enum { FIX_MODE_INVALID =  0 };
      enum { FIX_MODE_SPP =  1 };
      enum { FIX_MODE_DGNSS =  2 };
      enum { FIX_MODE_FLOAT_RTK =  3 };
      enum { FIX_MODE_FIX_RTK =  4 };
      enum { FIX_MODE_DEAD_RECKONING =  5 };
      enum { FIX_MODE_SBAS =  6 };
    ...
    const char * getType(){ return "piksi_rtk_msgs/PosLlhMulti"; };
    const char * getMD5(){ return "1432cd112c82b49dde4ea610842825ea"; };
