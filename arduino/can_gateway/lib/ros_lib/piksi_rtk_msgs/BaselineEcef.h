#ifndef _ROS_piksi_rtk_msgs_BaselineEcef_h
#define _ROS_piksi_rtk_msgs_BaselineEcef_h
...
namespace piksi_rtk_msgs
{
  ...
  class BaselineEcef : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "piksi_rtk_msgs/BaselineEcef"; };
    const char * getMD5(){ return "b632ba03d94241cc519a3a3e4885b973"; };
