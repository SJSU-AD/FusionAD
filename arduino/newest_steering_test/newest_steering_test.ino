...
ros::Subscriber<std_msgs::Float64> steering_sub("steering_channel", &steeringcallback); //subscriber initialization
ros::Publisher steering_response("steering_response", &feedback); // publish error instead 
