...
"""autogenerated by genpy from piksi_rtk_msgs/TrackingState.msg. Do not edit."""
import sys
...
class TrackingState(genpy.Message):
  _md5sum = "e7984ffda35159a5c451b134b22b20b1"
  _type = "piksi_rtk_msgs/TrackingState"
...
string frame_id
"""
  __slots__ = ['header','state','sat','code','cn0']
  _slot_types = ['std_msgs/Header','uint8[]','uint16[]','uint8[]','float32[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TrackingState, self).__init__(*args, **kwds)
