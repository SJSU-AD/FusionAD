...
"""autogenerated by genpy from piksi_rtk_msgs/BaselineNed.msg. Do not edit."""
import sys
...
class BaselineNed(genpy.Message):
  _md5sum = "d181eb2c9a6abff7c97c58dc9f4c0a7f"
  _type = "piksi_rtk_msgs/BaselineNed"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# This message reports the baseline solution in North East Down (NED) coordinates. This baseline is
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BaselineNed, self).__init__(*args, **kwds)
