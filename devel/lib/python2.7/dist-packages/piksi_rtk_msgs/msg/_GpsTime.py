...
"""autogenerated by genpy from piksi_rtk_msgs/GpsTime.msg. Do not edit."""
import sys
...
class GpsTime(genpy.Message):
  _md5sum = "d960bffb66122e272126ef7f2b6ef072"
  _type = "piksi_rtk_msgs/GpsTime"
...
string frame_id
"""
  __slots__ = ['header','wn','tow','ns','flags']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2IiB().pack(_x.wn, _x.tow, _x.ns, _x.flags))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.wn, _x.tow, _x.ns, _x.flags,) = _get_struct_2IiB().unpack(str[start:end])
      return self
