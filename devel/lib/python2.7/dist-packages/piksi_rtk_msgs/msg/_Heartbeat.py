...
"""autogenerated by genpy from piksi_rtk_msgs/Heartbeat.msg. Do not edit."""
import sys
...
class Heartbeat(genpy.Message):
  _md5sum = "f302769a534aa6ff5a3f6b1f1c11f4bc"
  _type = "piksi_rtk_msgs/Heartbeat"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# The heartbeat message is sent periodically to inform the host or other attached devices that the system
...
string frame_id
"""
  __slots__ = ['header','system_error','io_error','swift_nap_error','sbp_minor_version','sbp_major_version','external_antenna_present']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,system_error,io_error,swift_nap_error,sbp_minor_version,sbp_major_version,external_antenna_present
    ...
    if args or kwds:
      ...
      if self.sbp_minor_version is None:
        self.sbp_minor_version = 0
      if self.sbp_major_version is None:
        self.sbp_major_version = 0
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_6B().pack(_x.system_error, _x.io_error, _x.swift_nap_error, _x.sbp_minor_version, _x.sbp_major_version, _x.external_antenna_present))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.system_error, _x.io_error, _x.swift_nap_error, _x.sbp_minor_version, _x.sbp_major_version, _x.external_antenna_present,) = _get_struct_6B().unpack(str[start:end])
      return self
