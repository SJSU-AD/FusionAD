...
"""autogenerated by genpy from velodyne_puck_msgs/VelodynePuckSweep.msg. Do not edit."""
import sys
...
class VelodynePuckSweep(genpy.Message):
  _md5sum = "e0395900ded93e728803e208b8b88005"
  _type = "velodyne_puck_msgs/VelodynePuckSweep"
...
"""
  ...
  _slot_types = ['std_msgs/Header','velodyne_puck_msgs/VelodynePuckScan[16]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(VelodynePuckSweep, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.scans is None:
        self.scans = [velodyne_puck_msgs.msg.VelodynePuckScan() for _ in range(16)]
    else:
      self.header = std_msgs.msg.Header()
      self.scans = [velodyne_puck_msgs.msg.VelodynePuckScan() for _ in range(16)]
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.scans:
        buff.write(_get_struct_d().pack(val1.altitude))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.scans = []
      for i in range(0, 16):
        val1 = velodyne_puck_msgs.msg.VelodynePuckScan()
        start = end
        end += 8
        ...
        for i in range(0, length):
          val2 = velodyne_puck_msgs.msg.VelodynePuckPoint()
          _x = val2
          start = end
          end += 52
