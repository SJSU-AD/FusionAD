...
(cl:defclass <VelNed> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass VelNed (<VelNed>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <VelNed>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'VelNed)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name piksi_rtk_msgs-msg:<VelNed> is deprecated: use piksi_rtk_msgs-msg:VelNed instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <VelNed>))
...
(cl:defmethod h_accuracy-val ((m <VelNed>))
...
(cl:defmethod v_accuracy-val ((m <VelNed>))
...
(cl:defmethod n_sats-val ((m <VelNed>))
...
(cl:defmethod flags-val ((m <VelNed>))
  ...
  (flags m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <VelNed>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <VelNed>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<VelNed>)))
  "Returns string type for a message object of type '<VelNed>"
  "piksi_rtk_msgs/VelNed")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'VelNed)))
  "Returns string type for a message object of type 'VelNed"
  "piksi_rtk_msgs/VelNed")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<VelNed>)))
  "Returns md5sum for a message object of type '<VelNed>"
  "d181eb2c9a6abff7c97c58dc9f4c0a7f")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'VelNed)))
  "Returns md5sum for a message object of type 'VelNed"
  "d181eb2c9a6abff7c97c58dc9f4c0a7f")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<VelNed>)))
  "Returns full string definition for message of type '<VelNed>"
  (cl:format cl:nil "# This message reports the velocity in local North East Down (NED) coordinates. The NED coordinate~%# system is defined as the local WGS84 tangent plane centered at the current position. The full GPS time~%# is given by the preceding MSG GPS TIME with the matching time-of-week (tow).~%~%Header header~%~%uint32 tow          # GPS Time of Week.~%int32 n             # Velocity North coordinate [mm/s].~%int32 e             # Velocity East coordinate [mm/s].~%int32 d             # Velocity Down coordinate [mm/s].~%uint16 h_accuracy   # Horizontal velocity accuracy estimate (not implemented). Defaults to 0.~%uint16 v_accuracy   # Vertical velocity accuracy estimate (not implemented). Defaults to 0.~%uint8 n_sats        # Number of satellites used in solution.~%uint8 flags         # Status flags (reserved), see MSG_VEL_ECEF message description in SBP documentation.~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'VelNed)))
  "Returns full string definition for message of type 'VelNed"
  (cl:format cl:nil "# This message reports the velocity in local North East Down (NED) coordinates. The NED coordinate~%# system is defined as the local WGS84 tangent plane centered at the current position. The full GPS time~%# is given by the preceding MSG GPS TIME with the matching time-of-week (tow).~%~%Header header~%~%uint32 tow          # GPS Time of Week.~%int32 n             # Velocity North coordinate [mm/s].~%int32 e             # Velocity East coordinate [mm/s].~%int32 d             # Velocity Down coordinate [mm/s].~%uint16 h_accuracy   # Horizontal velocity accuracy estimate (not implemented). Defaults to 0.~%uint16 v_accuracy   # Vertical velocity accuracy estimate (not implemented). Defaults to 0.~%uint8 n_sats        # Number of satellites used in solution.~%uint8 flags         # Status flags (reserved), see MSG_VEL_ECEF message description in SBP documentation.~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <VelNed>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <VelNed>))
