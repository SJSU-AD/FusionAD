...
#include "../../../../../../src/utility/ethz_piksi_ros/rqt_gps_rtk_plugin/include/rqt_gps_rtk_plugin/GpsRtkPlugin.hpp"
...
const QMetaObject GpsRtkPlugin::staticMetaObject = {
    { &rqt_gui_cpp::Plugin::staticMetaObject, qt_meta_stringdata_GpsRtkPlugin.data,
      qt_meta_data_GpsRtkPlugin,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *GpsRtkPlugin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GpsRtkPlugin.stringdata0))
        return static_cast<void*>(const_cast< GpsRtkPlugin*>(this));
